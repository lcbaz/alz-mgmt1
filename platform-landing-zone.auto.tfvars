...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "lebarbosa@hotmail.com"
    ...
    primary_hub_address_space                          = "10.60.0.0/16"
    primary_hub_virtual_network_address_space          = "10.60.0.0/16"
    primary_nva_subnet_address_prefix                  = "10.60.2.0/24"
    primary_nva_ip_address                             = "10.60.2.4"
    primary_bastion_subnet_address_prefix              = "10.60.3.0/24"
    primary_gateway_subnet_address_prefix              = "10.60.4.0/24"
    primary_private_dns_resolver_subnet_address_prefix = "10.60.5.0/24"
  }
